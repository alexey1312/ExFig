...
/// Tests for WebIconsExporter conformance to AssetExporter and IconsExporter protocols.
final class WebIconsExporterTests: XCTestCase {
    ...
    func testConformsToIconsExporter() {
        let exporter: any IconsExporter = WebIconsExporter()
...
struct MockWebIconsExportContext: IconsExportContext {
    ...
    func withProgress<T: Sendable>(
        ...
        try await operation(MockWebIconsProgressReporter())
    }
}

/// Mock ProgressReporter for testing.
struct MockWebIconsProgressReporter: ProgressReporter {
