...
struct XcodeAssetContents: Encodable {
    ...
    struct ImageData: Encodable {
        ...
        init(
            ...
            self.idiom = idiom
            languageDirection = isRTL ? "left-to-right" : nil
            self.scale = scale
        }
    }
...
extension XcodeAssetContents.Appearance {
    static let dark = Self(appearance: "luminosity", value: "dark")
    static let highContrast = Self(appearance: "contrast", value: "high")
}
