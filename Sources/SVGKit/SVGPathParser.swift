...
private final class PathScanner: @unchecked Sendable {
    ...
    func scanNumber() throws -> Double? {
        ...
        // Optimization: Create Substring from original string instead of allocating new String from bytes
        // This relies on String.Index being shared between String and its views
        let substring = string[startIndex..<index]
